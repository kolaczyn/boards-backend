...
namespace boards.Migrations
{
    ...
    [Migration("20230815160443_AddCategoryLol")]
    partial class AddCategoryLol
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("boards.Infrastructure.Models.CategoryDb", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("boards.Infrastructure.Models.BoardDb", b =>
                {
                    b.HasOne("boards.Infrastructure.Models.CategoryDb", "Category")
                        .WithMany("Boards")
